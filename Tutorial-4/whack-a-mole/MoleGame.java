...
public class MoleGame extends JFrame {
	...
	private static JLabel[] molesArray = {new JLabel("mole1"), new JLabel("mole2"), new JLabel("mole3"), new JLabel("mole4"), new JLabel("mole5"), new JLabel("mole6"), new JLabel("mole7")};
	...
	public moleGame() {
		...
		// create a customer cursor based on an image
//		setCursor(Toolkit.getDefaultToolkit().createCustomCursor(
//				new ImageIcon("/Users/Tobias/Dropbox/UCL/Programming/Tutorial4/src/whack_a_mole/hammer.png").getImage(),
//				new Point(0,0),"custom cursor"));
	...
	public static void playSound(){
		try{
			...
			clip.open(AudioSystem.getAudioInputStream(new File("/Users/Tobias/Dropbox/UCL/Programming/Java/Tutorial4/src/whack_a_mole/clap.WAV")));
			clip.start();
		}
		catch(Exception e){
